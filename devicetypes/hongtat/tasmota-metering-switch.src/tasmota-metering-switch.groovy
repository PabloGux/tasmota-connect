...
def initialize() {
    ...
    def pwr4= "/?json={\"StatusSTS\":{\"POWER4\":\"%value%\"}}"
    def pwr5= "/?json={\"StatusSTS\":{\"POWER5\":\"%value%\"}}"
    def pwr6= "/?json={\"StatusSTS\":{\"POWER6\":\"%value%\"}}"
    def ene = "/?json={\"StatusSNS\":{\"ENERGY\":{\"Power\":\"%value%\"}}}"
    def tot = "/?json={\"StatusSNS\":{\"ENERGY\":{\"Total\":\"%value%\"}}}"
    pwr=encode(pwr)
    pwr1=encode(pwr1)
    pwr2=encode(pwr2)
    pwr3=encode(pwr3)
